...
export default function VerificatipnCodeScreen({ navigation, route }) {
  ...
  const handleSubmit = () => {
    ...
    console.log("Navigating to ResetPassword with email:", route.params?.email);

    if (verificationCode === '1234') { //dito ilagay ang code for verification
      if (route.params?.email) {
        console.log("Navigating to ResetPassword1...");
        navigation.navigate('ResetPassword1', { email: route.params.email });
      } else {
